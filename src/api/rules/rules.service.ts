...
import { refreshStudentProfile } from '../student-profile/studentProfile.service';
...
export async function listRules(filters: {
  ...
  let query = db('requirement_rules').where({ active: true });
...
export async function evaluateRules(
  studentRef: string,
  academicProfileInput?: AcademicProfile,
  projectId?: string
